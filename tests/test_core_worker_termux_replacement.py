...
def test_version_marks_bootstrap_to_self_builder_release() -> None:
    ...
    assert read(ANDROID / "README.md").startswith("# Core Worker 0.7.3 — autobuild mínimo e painéis reorganizados")
...
def test_termux_bootstrap_requires_self_builder_toolchain() -> None:
    ...
    assert 'PHONE_WORKER_VERSION = "1.10.35"' in phone_worker
