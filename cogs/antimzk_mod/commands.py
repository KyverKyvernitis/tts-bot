...
class AntiMzkCommandMixin:
    async def _run_antimzk_command(
        self,
    ...
    async def _handle_antimzk_error(self, interaction: discord.Interaction, error: app_commands.AppCommandError):
