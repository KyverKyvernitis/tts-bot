...
async def preparar_payload_tts_mensagem(
    cog,
    message,
    *,
    ...
    return PayloadTTSMensagem(text=text, resolved=resolved, queue_item=queue_item, forced_gtts=forced_gtts)
