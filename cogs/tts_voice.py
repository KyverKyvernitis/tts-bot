...
class TTSMainPanelView(_BaseTTSView):
    ...
    @discord.ui.button(label="Modo", style=discord.ButtonStyle.primary, emoji="🎛️", row=0)
    ...
    @discord.ui.button(label="Voz", style=discord.ButtonStyle.primary, emoji="🎙️", row=0)
    ...
    @discord.ui.button(label="Idioma", style=discord.ButtonStyle.primary, emoji="🌐", row=0)
    ...
    @discord.ui.button(label="Sair da call", style=discord.ButtonStyle.danger, emoji="📤", row=2)
    async def leave_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        await self.cog._leave_from_panel(interaction)


class TTSTogglePanelView(_BaseTTSView):
    @discord.ui.button(label="Bloqueio por outro bot", style=discord.ButtonStyle.primary, emoji="🤖", row=0)
    ...
    @discord.ui.button(label="Modo Cuca", style=discord.ButtonStyle.primary, emoji="👑", row=0)
