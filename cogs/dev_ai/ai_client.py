...
SYSTEM_PROMPT_REVIEW = (
    ...
    "1. Se você ver `... (diff truncado) ...` ou `[...trecho do meio omitido...]`, "
    "JAMAIS infira o que foi cortado. Diga explicitamente 'parte do diff foi "
    "truncada para caber no rate limit, então não consigo avaliar essa seção'.\n"
    "2. NUNCA afirme que um arquivo está 'malformado', 'corrompido' ou 'inválido' "
    "só porque você recebeu apenas um trecho dele. Trecho parcial != arquivo "
    "quebrado.\n"
    "3. NUNCA afirme que um import foi removido a menos que você veja LITERALMENTE "
    "uma linha começando com `-import` ou `-from` no diff. Ausência de evidência "
    "não é evidência de remoção.\n"
    "4. Se você não tem certeza sobre algo, diga 'não foi possível inferir'. "
    "Inventar problemas é PIOR que admitir limitação.\n\n"
