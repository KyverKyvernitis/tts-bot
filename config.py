...
MUSIC_WORKER_STREAM_CONNECT_TIMEOUT_SECONDS = max(3.0, _parse_float(os.getenv("MUSIC_WORKER_STREAM_CONNECT_TIMEOUT_SECONDS", "20.0"), 20.0))
MUSIC_WORKER_STREAM_READY_TIMEOUT_SECONDS = max(1.0, _parse_float(os.getenv("MUSIC_WORKER_STREAM_READY_TIMEOUT_SECONDS", "18.0"), 18.0))
MUSIC_WORKER_STREAM_PREBUFFER_SECONDS = max(0.1, _parse_float(os.getenv("MUSIC_WORKER_STREAM_PREBUFFER_SECONDS", "2.0"), 2.0))
MUSIC_WORKER_STREAM_MAX_BUFFER_SECONDS = max(1.0, _parse_float(os.getenv("MUSIC_WORKER_STREAM_MAX_BUFFER_SECONDS", "8.0"), 8.0))
